...
namespace MSG.UnitTests
{
    ...
    class GeneratorTests
    {
        ...
        public void VerifyBlankManaging()
        {
            ...
            Assert.AreEqual("The Head of Marketing culturally address the overarching issueses at the individual, team and organizational level.", output);
        }

        [Test]
        public void VerifySpacingInManagingHead()
        {
            MoqUtil.SetupRandMock(1, 7, 1, 17, 1, 1, 5, 6, 3, 2, 14, 8, 9, 19, 33);
